...
// Edge runtime (V8 isolates) -- no OTel SDK, so getActiveSpan() always returns
// undefined and the bridge passes events through unchanged. Wired anyway so the
// trio of {client, server, edge} stays symmetric and doesn't drift on later
// edits.
